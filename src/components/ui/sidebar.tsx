...
>(({ className, children, ...props }, ref) => {
    ...
    return (
      <aside
        ...
        data-state={state}
        className={cn(
          "group hidden md:flex flex-col bg-sidebar text-sidebar-foreground",
          className
        )}
        {...props}
      >
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left outline-none ring-sidebar-ring transition-colors focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50",
  {
    variants: {
      variant: {
